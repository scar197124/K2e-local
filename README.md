...
- Restores the original full-size social preview image so all text fits cleanly inside the frame.
- Replaces the reduced/cropped preview variants used for README and GitHub social sharing.
- Updates metadata dimensions and cache-busting for the restored image.
- Preserves the v1.12.5 metadata and release-consistency improvements.

## v1.12.5 — Metadata, README, and Release Consistency Polish

- Adds a cleaner README launch section and trust highlights.
- Aligns metadata, manifest, service-worker cache naming, and release validation.
- Adds social-preview setup guidance and a lightweight preview checklist.
