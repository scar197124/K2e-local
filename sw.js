...
const APP_SHELL = [
  ...
  './assets/k2e-local-brand-night.png','./assets/k2e-local-social-preview.png','./assets/k2e-local-home-visual-locked-dark.webp','./assets/k2e-local-home-visual-locked-light.webp','./assets/k2e-logo-horizontal-dark.png','./assets/k2e-logo-horizontal-light.png',
  './assets/chart.umd.js',
