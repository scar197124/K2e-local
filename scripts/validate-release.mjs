...
if (!index.includes("k2e-local-social-preview.png?v=1.12.7")) throw new Error("Landing-page social preview metadata missing or stale");
if (!app.includes("k2e-local-social-preview.png?v=1.12.7")) throw new Error("App social preview metadata missing or stale");
if (!serviceWorker.includes("k2e-local-v1.12.7-pages-url-fix")) throw new Error("Service-worker cache name is stale");
